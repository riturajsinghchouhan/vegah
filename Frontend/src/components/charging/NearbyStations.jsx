  ...
  return (
    <div className="px-5 mb-8">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-[17px] font-bold text-gray-900 leading-tight">Nearby Stations</h2>
      ...
      <div className="flex flex-col gap-0">
        {stations.length > 0 ? (
          ...
          <div className="py-8 text-center bg-gray-50 rounded-[20px] border border-gray-100">
            <h3 className="text-[14px] font-bold text-gray-900 mb-1">No charging stations nearby</h3>
