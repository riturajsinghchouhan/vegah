  ...
  return (
    <div className="flex items-center justify-between px-5 pt-8 pb-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-[18px] font-bold text-gray-900 tracking-tight leading-tight">Find Charging Stations</h1>
          <p className="text-[11px] text-gray-500 font-medium mt-0.5">Find charging stations near you</p>
        </div>
      </div>
