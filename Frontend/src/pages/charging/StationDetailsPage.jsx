...
const StationDetailsPage = () => {
  ...
  return (
    <main className="page-padding">
      <PageHeader showBack subtitle="Station details and charger availability" title={station.name} />
      ...
      <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="space-y-6">
          ...
          <section className="surface-card p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-app-subtle">Charging hub</p>
        ...
        <div className="space-y-6">
          <section className="surface-card p-5">
            <h3 className="text-lg font-semibold text-app-text">Charger status</h3>
