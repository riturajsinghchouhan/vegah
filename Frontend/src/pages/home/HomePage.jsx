    ...
    <div className="bg-[#FAFAFA] min-h-screen pb-24 relative overflow-x-hidden font-sans">
      ...
      <div className="px-4 mb-5 flex items-center gap-3">
        <div className="flex-1 flex items-center gap-2 bg-white rounded-full border border-gray-200 px-4 py-3 shadow-sm">
          ...
          <input 
            type="text" 
            placeholder="Search destination, car or offer" 
      ...
      <div className="px-4 mb-6 overflow-x-auto no-scrollbar">
        <div className="flex items-center gap-3 w-max">
          <div className="flex flex-col items-center justify-center bg-white rounded-2xl border border-[#FF5500] w-[80px] py-3 shadow-sm">
            <img src="/assets/category/18ab8fbf-0957-4003-a27b-d1cf1ce9d68f.png" alt="Hatchback" className="h-8 object-contain mb-2" />
            <span className="text-[10px] font-bold text-gray-900">Hatchback</span>
          ...
          <div className="flex flex-col items-center justify-center bg-white rounded-2xl border border-gray-100 w-[80px] py-3 shadow-sm">
            <img src="/assets/category/2fc37eaa-6b55-4703-bf9c-3d02ce3674e4.png" alt="Sedan" className="h-8 object-contain mb-2" />
            <span className="text-[10px] font-bold text-gray-900">Sedan</span>
            <span className="text-[8px] text-gray-500">From ₹999</span>
          </div>
          <div className="flex flex-col items-center justify-center bg-white rounded-2xl border border-gray-100 w-[80px] py-3 shadow-sm">
            <img src="/assets/category/80403236-3851-41fd-af84-1f5f53514bdc.png" alt="SUV" className="h-8 object-contain mb-2" />
            <span className="text-[10px] font-bold text-gray-900">SUV</span>
            <span className="text-[8px] text-gray-500">From ₹1499</span>
          </div>
          <div className="flex flex-col items-center justify-center bg-white rounded-2xl border border-gray-100 w-[80px] py-3 shadow-sm">
            <img src="/assets/category/a8d84954-c85d-4a06-82d1-3ef9587e9844.png" alt="Luxury" className="h-8 object-contain mb-2" />
            <span className="text-[10px] font-bold text-gray-900">Luxury</span>
            <span className="text-[8px] text-gray-500">From ₹2499</span>
          </div>
          <div className="flex flex-col items-center justify-center bg-white rounded-2xl border border-gray-100 w-[80px] py-3 shadow-sm">
      ...
      <div className="px-4 mb-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 relative">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold text-gray-900">Rent a Car</h2>
          </div>
      ...
      <div className="mb-6 pl-4">
        <div className="flex items-center justify-between pr-4 mb-4">
          <h2 className="text-base font-bold text-gray-900">Popular Cars</h2>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-[8px] text-gray-500 leading-snug">Verified cars & drivers</p>
            </div>
          </div>
          <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm flex items-start gap-2">
