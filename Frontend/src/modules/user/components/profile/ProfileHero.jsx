    ...
    <div className="px-5 mb-8">
      <div className="flex items-center gap-4 cursor-pointer group">
        ...
        <div className="relative shrink-0">
          ...
          <button className="absolute bottom-0 right-0 w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-md border border-gray-100 text-gray-600 hover:text-[#272664] active:scale-95 transition-all">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1.5 flex-wrap">
            ...
            <div className="bg-[#e8e8f2] text-[#272664] flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-bold whitespace-nowrap">
        ...
        {/* Action Chevron */}
        <div className="shrink-0 text-gray-400 group-hover:text-[#272664] group-hover:translate-x-1 transition-all">
