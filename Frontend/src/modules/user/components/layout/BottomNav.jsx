...
const BottomNav = () => (
  <nav className="fixed inset-x-0 bottom-0 z-40 px-3 pb-3">
    <div className="mx-auto flex max-w-[406px] items-center justify-center gap-12 rounded-[22px] border border-app-border bg-white px-3 py-2.5 shadow-[0_12px_36px_rgba(16,24,40,0.08)]">
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            `flex min-w-[56px] flex-col items-center gap-1 rounded-2xl px-2 py-1 text-[10px] font-medium transition ${
              isActive ? "text-[#272664]" : "text-app-subtle"
            }`
          }
          to={path}
        >
