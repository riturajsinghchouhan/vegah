...
const LicensePage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!licenseNumber || !frontImage || !backImage) {
    ...
    try {
      ...
      alert("Driving License details saved successfully!");
  ...
  return (
    <div className="bg-[#F8F9FA] min-h-screen pb-28 font-sans">
      <PageHeader title="Driving License" showBack={true} />
      ...
      <div className="px-5 mt-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            ...
            />
            <p className="text-xs text-gray-500 mt-2">Enter the exact driving license number as printed on the card.</p>
          </div>
            ...
            <div className="relative h-40 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 flex flex-col items-center justify-center overflow-hidden">
              {frontImage ? (
                <div className="w-full h-full relative group">
                  <img src={frontImage} alt="License Front" className="w-full h-full object-cover" />
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            ...
            <div className="relative h-40 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 flex flex-col items-center justify-center overflow-hidden">
              {backImage ? (
                <div className="w-full h-full relative group">
                  <img src={backImage} alt="License Back" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <span className="text-white font-medium text-sm flex items-center gap-2">
                      <Upload size={16} /> Change Photo
                    </span>
          ...
          <Button type="submit" disabled={isSubmitting || !licenseNumber || !frontImage || !backImage} className="w-full h-12 text-[15px]">
