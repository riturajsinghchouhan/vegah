    ...
    <div className="bg-[#FAFAFA] min-h-screen pb-24 relative overflow-x-hidden font-sans">
      ...
      <div className="px-4 mb-6 overflow-x-auto no-scrollbar">
        <div className="flex items-center gap-3 w-max">
          <Link to="/user/vehicles?category=Electric" className="flex flex-col items-center justify-center bg-white rounded-2xl border border-[#FF5500] w-[80px] py-3 shadow-sm">
          ...
          <Link to="/user/vehicles?category=Performance" className="flex flex-col items-center justify-center bg-white rounded-2xl border border-gray-100 w-[80px] py-3 shadow-sm">
          ...
          <Link to="/user/vehicles?category=City" className="flex flex-col items-center justify-center bg-white rounded-2xl border border-gray-100 w-[80px] py-3 shadow-sm">
          ...
          <Link to="/user/vehicles?category=Premium" className="flex flex-col items-center justify-center bg-white rounded-2xl border border-gray-100 w-[80px] py-3 shadow-sm">
          ...
          <Link to="/user/vehicles" className="flex flex-col items-center justify-center bg-white rounded-2xl border border-gray-100 w-[80px] py-3 shadow-sm">
          ...
          <div className="space-y-3">
            <div className="border border-gray-200 rounded-xl p-3 relative">
              ...
              <div className="flex items-center justify-between relative">
                <select className="w-full appearance-none bg-transparent text-sm font-semibold text-gray-800 outline-none pr-6 cursor-pointer" defaultValue="">
                  <option value="" disabled>Select pickup location</option>
                  <option value="indore">South Tukoganj, Indore</option>
                  <option value="bhopal">MP Nagar, Bhopal</option>
                  <option value="pune">Koregaon Park, Pune</option>
                </select>
            ...
            <div className="flex gap-2">
              <div className="flex-1 border border-gray-200 rounded-xl p-3">
                ...
                <input type="datetime-local" className="w-full bg-transparent text-xs font-semibold text-gray-800 outline-none cursor-pointer" defaultValue="2024-05-14T10:00" />
              </div>
              <div className="flex-1 border border-gray-200 rounded-xl p-3">
                <label className="text-[10px] text-gray-500 mb-1 flex items-center gap-1 block">
                  <Calendar size={12} className="text-gray-400" /> Drop-off
                </label>
                <input type="datetime-local" className="w-full bg-transparent text-xs font-semibold text-gray-800 outline-none cursor-pointer" defaultValue="2024-05-16T10:00" />
              </div>
            </div>

            <Link to="/user/vehicles" className="bg-[#FF5500] text-white rounded-xl py-3.5 px-4 flex items-center justify-center gap-2 text-sm font-bold shadow-md w-full mt-2 hover:bg-[#E64D00] transition">
